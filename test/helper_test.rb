...
class HelperTest < ActionView::TestCase
  ...
  def test_vite_javascript_tag
    assert_equal [
      %(<script src="/vite-production/assets/application.a0ba047e.js" type="module" crossorigin="anonymous"></script>),
    ...
    with_dev_server_running {
      assert_equal %(<script src="/vite-production/application.js" type="module" crossorigin="anonymous"></script>),
        vite_javascript_tag('application')

      assert_equal %(<script src="/vite-production/application.ts.js" type="module" crossorigin="anonymous"></script>),
